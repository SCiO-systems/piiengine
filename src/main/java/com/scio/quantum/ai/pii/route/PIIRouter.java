...
import com.scio.quantum.ai.pii.aggregations.*;
...
public class PIIRouter extends RouteBuilder {
    ...
    public PIIRouter(String elasticsearchClusterName, String elasticsearchIP, String kafkaBroker, String uiLocation) {
    ...
    public void configure() throws Exception {
        ...
        from("direct:prepareJob")
                .routeId("PII-D-IN")
                .setProperty("UIIP",constant(this.uiLocation))
                ...
                .to("smtp://" +
                        "mail.scio.systems:587?" +
                        "username=info@scio.systems&" +
                        "password=^5X3m1lf&" +
